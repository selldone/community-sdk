export default class CAPI {
  ...
  constructor() {
    let selldone_gapi_meta = document.head.querySelector(
      'meta[name="selldone-capi"]'
    );
    if (selldone_gapi_meta) this.selldone_capi_url = selldone_gapi_meta.content;

  }


  //―――――――――――――――――――――― Shop ――――――――――――――――――――
  POST_COMMUNITY_CREATE(shop_id) {
  ...
  //―――――――――――――――――――――― Profile ――――――――――――――――――――
  GET_COMMUNITY_PROFILE_FULL(user_id) {
  ...
  POST_GENERATE_DOWNLOAD_ATTACHMENT_URL(community_id,post_id,file_id) { // Return temporary URL!
